...
module.exports = {
  ...
  run: async (client, interaction) => {
    ...
    .setDescription(`Olá ${interaction.user}, me chame de BOT Supremo, sou um bot que ainda está em desenvolvimento. \n veja meus comandos interagindo com o painel abaixo:`);
